...
|                             | Нью-Дели       | Video Delivery, Upload, Search/Recommendations | Север Индии, крупный узел для поиска и рекомендаций, отдельный кэш популярных региональных видео. |
|                             | Калькутта      | Video Delivery, CDN                            | Восток страны; локальное кэширование и доставка видео.                                            |
|                             | Бангалор       | Video Delivery, Upload                         | Южная зона, поддержка пиковых нагрузок на загрузку и delivery.                            |
| **США**                     | Сиэтл          | Video Delivery, Upload                         | Западное побережье, доставка контента для западной части страны, локальное кэширование.           |
|                             | Лос-Анджелес   | Video Delivery, CDN                            | Западное побережье, популярные видео, фронтенд статика.                                           |
...
| **Мексика**                 | Мехико         | Video Delivery, CDN                            | Центральная Америка, локальный delivery и кэш.                                                    |
| **Индонезия**               | Джакарта       | Video Delivery, Upload, CDN                    | Основной центр, региональное кэширование, доставка видео.                                         |
| **Япония**                  | Токио          | Video Delivery, Search/Recommendations         | Поиск и рекомендации с локальными трендами; доставка видео.                                       |
| **Германия**                | Франкфурт      | Video Delivery, Upload, CDN, Comments          | Основной хаб для Европы, централизованные комментарии для минимизации глобального трафика.        |
...
| **Африка**                  | Йоханнесбург   | Video Delivery, Upload                         | Южная Африка, доставка видео, локальное кэширование.                                              |
