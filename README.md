...
* Легкая бизнес-логика: 1 ядро CPU = 500 RPS и 50 Кбайт RAM/запрос
* Средняя бизнес-логика: 1 ядро CPU = 100 RPS и 500 Кбайт RAM/запрос
* Тяжелая бизнес-логика: 1 ядро CPU/(1000 потоков) и 50 Мбайт RAM/(1000 потоков) 

#### **Stateless-сервисы (Kubernetes)**

| Сервис                              | Пиковая нагрузка (RPS) | Тип обработки        | CPU  | RAM   | Требуемые CPU | Требуемая RAM, ГБ |
|-------------------------------------|-------------------------|----------------------|------|-------|---------------|-------------------|
| API (просмотры, лайки, комменты)    | 213 000                | Средняя логика Go    | 100  | 500   | 2130          | 106,5             |
| Search API                          | 101 000                | Средняя логика Go    | 100  | 500   | 1010          | 50,5              |
| Recommendation service              | 104 000                | ML heavy             | 50   | 1000  | 2080          | 104               |
| Upload                              | 500                    | Средняя логика       | 100  | 500   | 5             | 0,25              |
| Kafka helpers                       | 2 000                  | Лёгкая логика        | 500  | 50    | 4             | 0,1               |
| **Итого**                           | —                      | —                    | —    | —     | **5229**      | **261,35**        |
...
**Тип воркер-ноды:** 48 vCPU / 300 ГБ RAM (приближённый аналог Hetzner PX)


| Сервис         | Replicas | CPU request | CPU limit | RAM request | RAM limit | Total CPU |
| -------------- | -------- | ----------- | --------- | ----------- | --------- | --------- |
| API            | 200      | 0.4         | 0.6       | 256 MiB     | 512 MiB   | 80        |
| Search API     | 80       | 0.6         | 1         | 300 MiB     | 600 MiB   | 48        |
| Recommendation | 350      | 6           | 7         | 600 MiB     | 1 GiB     | 2100      |
| Upload         | 10       | 0.3         | 0.5       | 512 MiB     | 1 GiB     | 4         |
| Kafka helpers  | 20       | 0.7         | 1         | 700 MiB     | 1 GiB     | 14        |


Суммарный CPU: ~2264 vCPU
Нода: 48 vCPU
Требуемо: ~47,2 нод — округлённо 50


#### **Stateful-ноды**

| Кластер                                                      | Конфигурация ноды                 | Кол-во нод | CPU всего | RAM всего | Диски               |
| ------------------------------------------------------------ | --------------------------------- | ---------- | --------- | --------- | ------------------- |
| **PostgreSQL**                                               | 16 vCPU / 64 ГБ / 2×1.92 TB NVMe  | 12         | 192       | 768 ГБ    | NVMe (OLTP)         |
| **Elasticsearch**                                            | 24 vCPU / 108 ГБ / 4×1.92 TB NVMe | 9          | 216       | 972 ГБ    | NVMe (I/O bound)    |
| **ClickHouse**                                               | 16 vCPU / 64 ГБ / 4×3.84 TB NVMe  | 8          | 128       | 512 ГБ    | NVMe (sequential)   |
| **Redis**                                                    | 4 vCPU / 32 ГБ / 1×0.96 TB NVMe   | 8          | 32        | 256 ГБ    | NVMe (AOF)          |
| **Kafka**                                                    | 8 vCPU / 32 ГБ / 4×3.84 TB NVMe   | 4          | 32        | 128 ГБ    | NVMe (log segments) |
| **Service nodes (K8s control-plane, CI/CD, S3, monitoring)** | 8 vCPU / 32 ГБ / 1×960 GB NVMe    | 3          | 24        | 96 ГБ     | NVMe                |
