...
$$
\text{Размер видео} = \frac{1\ \text{(Mbps)} \times 702\ \text{(сек)}}{8 \times 1024^3} \approx 0.086\ \text{ГБ}
$$
...
$$
\text{Общий размер всех видео}  = \text{0,685 (ГБ)} \times \text{5,1 (млрд)} ≈ \text{3 ЭБ}
$$
...
$$
\text{Итоговый общий объём} ≈ \text{3,9 ЭБ}
$$
...
|------------|------------|----------------|-------------|-----------------------|
| Видео (усреднённо, базовое 1080p + коррекция на другие разрешения) | 5,1 млрд | 0,685 ГБ | ~3,9 ЭБ | ~3993 ПБ |
...
$$
\text{Общий размер всех видео за сутки} = 3,7 \text{ млн} \times text{0,685 (ГБ)} \times 1,3 ≈ 3,14 \text{ ПБ}
$$
...
|------------|-------------------|----------------|--------------------|---------------------------|
| Видео (усреднённо, 1080p + коррекция) | 3,7 млн | 0,685 ГБ × 1,3 коррекция | ~3,14 ПБ | 3,14 |
