...
4. *Среднее количество действий на пользователя в день (если явно не указано, берём оценки на основе продуктовых метрик):**
   * **Загрузка видео:** общее количество новых видео в сутки (3,7 млн) делим на DAU → 0,03 загрузки/пользователь/день.
   * **Поиск видео:** общее количество поисковых запросов в день (3,5 млрд) делим на DAU → 29 поисков/пользователь/день.
...
| ----------------------------- | ------------------------------------------ | ----------- | ----------- |
| Загрузка видео                | 0,03                                       | 43          | 108         |
| Просмотр видео                | 9                                          | 12 708      | 31 770      |
| Поиск видео                   | 29                                         | 40 509      | 101 272     |
| Комментирование видео         | 0,036                                      | 51          | 128         |
| Оценка видео (лайк/дизлайк)   | 0,36                                       | 508         | 1 270       |
| Подписка на канал             | 0,036                                      | 51          | 128         |
| Получение списка рекомендаций | 9                                          | 12 708      | 31 770      |
...
| ----------------------------- | ----------- | ----------- | --------------------- | ----------------------- | ----------------------- | -------------------------- |
| Загрузка видео                | 43          | 108         | 0,685 ГБ              | 0,236                   | 0,59                    | 2 400                      |
| Просмотр видео                | 12 708      | 31 770      | 0,685 ГБ              | 74 652                  | 186 630                 | 7 890 000                  |
| Поиск видео                   | 40 509      | 101 272     | 50 КБ                 | 16,2                    | 40,5                    | 172                        |
| Комментирование видео         | 51          | 128         | 1 КБ                  | 0,000408                | 0,00102                 | 4,3                        |
| Оценка видео (лайк/дизлайк)   | 508         | 1 270       | 0,5 КБ                | 0,00203                 | 0,00508                 | 21,5                       |
| Подписка на канал             | 51          | 128         | 0,5 КБ                | 0,000204                | 0,00051                 | 2,15                       |
| Получение списка рекомендаций | 12 708      | 31 770      | 50 КБ                 | 0,635                   | 1,588                   | 6 140                      |
