...
| Сервис                           | Пиковая нагрузка (RPS) | Тип обработки        | Удельная производительность | Требуемые CPU | RAM        |
| -------------------------------- | ---------------------- | -------------------- | --------------------------- | ------------- | ---------- |
| API (просмотры, лайки, комменты) | 213 000                | Лёгкая логика Golang | ~2300 RPS/ядро              | ~96           | 48 ГБ      |
| Search API                       | 101 000                | Лёгкая логика Golang | ~2200 RPS/ядро              | ~48           | 24 ГБ      |
| Recommendation service           | 104 000                | ML heavy             | ~50 RPS/ядро                | ~2100         | 256 ГБ     |
| Upload                           | 500                    | Средняя логика       | ~150 RPS/ядро               | ~4            | 8 ГБ       |
| Kafka helpers                    | 2 000                  | Лёгкая логика        | ~120 RPS/ядро               | ~16           | 16 ГБ      |
| **Итого**                        | —                      | —                    | —                           | **~2264 CPU** | **352 ГБ** |
